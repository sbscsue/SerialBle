...
namespace Jenx.Bluetooth.GattServer.Common
{
    public class GattServer : IGattServer
    {
        ...
        public async Task<bool> AddNotifyCharacteristicAsync(Guid characteristicId,  string userDescription = "N/A")
        {
            ...
            await _logger.LogMessageAsync("setset");
            setNotifyCharaterisitic(characteristicResult);
            
            return characteristicResult.Error == BluetoothError.Success;
        }

        public void setNotifyCharaterisitic(GattLocalCharacteristicResult gattResult)
        {
        ...
        public async void runNotifyCharaterstic(Windows.Storage.Streams.IBuffer value)
        {
            ...
            {
                await _logger.LogMessageAsync("no");
            }
            
        }
        public bool getNotifyCharateristicStateAsync()
        {
